...
// Textes constants pour les différentes parties du PDF
...
// Styles par défaut pour les documents PDF
...
// Constantes pour les tableaux
export const TABLE_COLUMN_WIDTHS = {
  DETAILS: ['*', 50, 50, 30, 60], // Description, Quantité, Prix HT, TVA, Total HT
  TOTALS: [50, 80] // Largeurs pour les tableaux de totaux
};

// Utilitaires de formatage pour les nombres
