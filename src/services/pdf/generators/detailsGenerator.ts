...
import { TABLE_COLUMN_WIDTHS, formatMOFournitures, formatPrice, formatQuantity } from '@/services/pdf/utils/pdfUtils';
...
export const prepareDetailsContent = (
  ...
  const tableHeaderRow = [
    { text: 'Description', style: 'tableHeader', alignment: 'left', color: '#002855' },
    { text: 'Quantité', style: 'tableHeader', alignment: 'center', color: '#002855' },
    { text: 'Prix HT Unit.', style: 'tableHeader', alignment: 'center', color: '#002855' },
    { text: 'TVA', style: 'tableHeader', alignment: 'center', color: '#002855' },
    { text: 'Total HT', style: 'tableHeader', alignment: 'center', color: '#002855' }
  ];
  ...
  const docContent: any[] = [
    // Titre de la section - Utilisation des paramètres PDF si disponibles
    {
      ...
      color: pdfSettings?.elements?.details_title?.color || '#002855',
